...
def main():
	...
	list_of_trfrac=np.array([1.0]) # ([.5,.6,.7,.8,.9,1.0])
	list_of_frac=np.array( [ 0.6, 0.7, 0.8, 0.9, 1.0 ] )#([.8])
	list_of_lambda=np.array( [ [  .5, .7, .9, 1.0, 1.2 ][int( sys.argv[3]) ] ] )
	...
	prefix='data/' # '../Cherrypick_others/Data_opn_dyn_python/'
